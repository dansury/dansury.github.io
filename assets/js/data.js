...
window.SITE = (function () {
  ...
  var i18n = {
    ru: {
      ...
      'stack.title': 'Стек',
      'stack.lede': 'Инструмент выбирается под контур заказчика и срок поддержки.',
  ...
  var projects = [
    ...
    },
    {
      ...
      ru: {
        ...
        value: 'Пять часов ручной работы превратились в минуту, ошибки ушли вместе с ручным этапом, а подлинность покупатель проверяет сам.'
      },
      en: {
    ...
    },
    {
      ...
      ru: {
        ...
        value: 'Первый шаг воронки бесплатный и автоматический — время автора уходит только на оплативших.'
      },
      en: {
        name: 'CareerHack · Executive Matrix',
